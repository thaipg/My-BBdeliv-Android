...
import kotlinx.android.synthetic.main.content_create_detail.*
...
class CreateDetailActivity : BaseSubActivity(), View.OnClickListener {
    ...
    private fun bindData() {
        ...
        if (shipment.paymentType != null)
        {
            typePay = shipment.paymentType
            btTypePay.text = typePay!!.name
        }
    ...
    private fun calculated() {
        ...
        val dvgt = JSONArray(serviceDVGT.map { it.id.toString() })
        val json = JSONObject()
        ...
        json.put("COD", cod.toString())
        json.put("Insured", insured.toString())
    ...
    private fun nextStep() {
        ...
        ShipmentProcess().updateShipment(this, shipment, {
            val intent = Intent()
    ...
    private fun setupUI(view: View) {
        ...
        if (view !is EditText) {
            view.setOnTouchListener { v, event ->
                view.clearFocus()
                hideSoftKeyboard(this@CreateDetailActivity)
                false
            }
        }
