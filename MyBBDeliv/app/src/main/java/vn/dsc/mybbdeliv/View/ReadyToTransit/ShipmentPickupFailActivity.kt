...
import kotlinx.android.synthetic.main.content_shipment_pickup_fail.*
...
class ShipmentPickupFailActivity : BaseSubActivity() , View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_shipment_pickup_request_reject)
        prepareUI()
        bindData()
    }
    ...
    private fun setupUI(view: View) {
        ...
        if (view !is EditText) {
            view.setOnTouchListener { v, event ->
                view.clearFocus()
                hideSoftKeyboard(this@ShipmentPickupFailActivity)
                false
            }
        }
